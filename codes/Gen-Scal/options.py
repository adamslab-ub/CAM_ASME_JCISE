...
def get_options(args=None):
    ...
    parser.add_argument('--n_agents', type=int, default=51, help="Number of robots")
    ...
    parser.add_argument('--agent_max_capacity', type=int, default=5, help="Max capacity for the robot")
    parser.add_argument('--agent_max_speed', type=int, default=10, help="Max speed for the robot")
    parser.add_argument('--enable_capacity_constraint', type=bool, default=True, help="Set it to true to enable capacity constraint")
